<template>
  <Section heading="Key/Value Display">
    ...
    <SubSection heading="Alt" class="grid gap-4">
      <p-key-value label="Group" value="Ninja Turtles" alternate>
        <template #value>
      ...
      <p-key-value label="Story" alternate>
        <template #value>
      ...
      <p-key-value label="Leader" value="Leonardo" alternate />
      <p-key-value label="Brains" value="Donatello" alternate />
      <p-key-value label="Brawn" value="Raphael" alternate />
      <p-key-value label="Comic Relief" value="Michelangelo" alternate />

      <p-divider />

      <p-key-value label="Weaknesses" alternate>
        <template #empty>
      ...
      <p-key-value label="Nemesis" value="Shredder, Karai, Baxter Stockman, Krang" alternate />
    </SubSection>
  </Section>
</template>
