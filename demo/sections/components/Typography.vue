<template>
  ...
  >
    <template #description>
      This is where we add a short description of <p-code>p-typography</p-code>. Describe the components intent, not hyper specific documentation that belongs on vitepress page.
    </template>
    ...
    <template #fonts>
      ...
      <div class="mb-4">
        ...
        <p class="text-sm text-gray-500">
          Use for form field labels, Key/Value pairs
        </p>
      </div>
      <div class="mb-4">
        <p class="text-base">
      ...
      <div class="mb-4">
        ...
        <p class="text-sm text-gray-500">
          Use for Seconary page headings (Modals, Panels)
        </p>
      </div>
      <div class="mb-4">
        <p class="text-2xl">
        ...
        <p class="text-sm text-gray-500">
          Use for Primary Page Navigation Headers (Breadcrumb)
        </p>
      </div>
      <div class="mb-4">
        <p class="text-3xl">
        ...
        <p class="text-sm text-gray-500">
          Use for Hero Text Headings (Empty States, Marketing Screens)
        </p>
      </div>
    </template>
